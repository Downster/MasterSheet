...
function storeTheme(themeName) {
   // const cookie = `theme=${themeName};` //created a variable to store as cookie
   // document.cookie = cookie; //referenced that variable as a new cookie
 // Phase 1
...
function restoreTheme() {
    ...
    //     let cookies = document.cookie.split(";") //arr of cookies
    //     let value = cookies.at(cookies.indexOf("theme")+1);
    //     console.log(value);
    //     setTheme(value.split(";")[0]);
    // }
...
function restoreName() {
    ...
    //     let value = cookies.at(cookies.indexOf("Name"));
    //     console.log(cookies)
    //     // console.log(value)
