...
function storeTheme(themeName) {
    sessionStorage.setItem("theme",themeName); //stores the theme in the sess
}
...
function restoreTheme() {
    ...
    if(sessionStorage.getItem("theme")){ //checks if sessionStorage has a theme selected
        const previousTheme = sessionStorage.getItem("theme"); //creates a var of the theme selected
        setTheme(previousTheme); //sets the theme in a function
    }
